...
class HCSR04:
    ...
    def __init__(self, pin_trigger: int, pin_echo: int) -> None:
        ...
        :param pin_trigger: a int with the number of the Pin the trigger is connected to
        :param pin_echo: a int with the number of the Pin the echo is connected to
        """
