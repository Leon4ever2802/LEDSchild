...
class Leds:
    """
    A LED class for a LED stripe.
    It can change the color of all LEDs inside the stripe in different ways:\n
    - simply set
    - fade
    - rainbow
    - change the color depending on the distance measured by the HCSR04-sensor
    """
    ...
    def __init__(self, num_leds: int, pin: int):
        ...
        :param num_leds: the count of the LEDs in the Stripe
        :param pin: Port-number of the Pin on the Raspberry
        """
    ...
    def set_all(self, color: (int, int, int)) -> None:
        ...
        :param color: new color for the LED-Stripe
        :return: None
        """
    ...
    def set_rainbow_task(self, rainbow_task: Task) -> None:
        """
        Sets the rainbow task to the given task
        
        :param rainbow_task: current rainbow task
        :return: None
        """
    ...
    def fade_to(self, color_to: (int, int, int)) -> None:
        ...
        :param color_to: the wanted color which should be faded to
        :return: None
        """
